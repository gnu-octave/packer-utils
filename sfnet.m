db.config={'~/.octave/pckr.mat' 'https://github.com/octave-de/p/pckr.m'};
...
db.sfnet={...
 ...
 '@cgi'} {...
	...
	'sf.net' 'control' '2.6.3' 'http://downloads.sourceforge.net/project/octave/Octave%20Forge%20Packages/Individual%20Package%20Releases/' 'GPLv3+' {...
	...
	'sf.net' 'ncarray' '1.0.2' 'http://downloads.sourceforge.net/project/octave/Octave%20Forge%20Packages/Individual%20Package%20Releases/' 'GPLv2+' {...
		'test_ncarray_nan' 'test_ncarray' 'cached_decompress' 'nccoord' 'ncCatArray' '@BaseArray' '@CatArray' '@ncArray' '@ncBaseArray'} {...
		' octave (>= 3.4.0)';
		' netcdf (>= 1.0.2)';
		' statistics (>= 1.0.6)';
		};
	...
	'sf.net' 'netcdf' '1.0.2' 'http://downloads.sourceforge.net/project/octave/Octave%20Forge%20Packages/Individual%20Package%20Releases/' 'GPLv2+' {...
	...
	'sf.net' 'quaternion' '2.2.0' 'http://downloads.sourceforge.net/project/octave/Octave%20Forge%20Packages/Individual%20Package%20Releases/' 'GPLv3+' {...
